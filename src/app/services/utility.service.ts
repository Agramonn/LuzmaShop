...
import { Payment, Product, User, UserCart, UserCartItem } from '../models/models';
...
export class UtilityService {
  ...
  calculatePricePaid(cart: UserCart){
    let pricepaid=0;
  ...
  calculatePayment(cart: UserCart, payment: Payment){
    ...
    if(payment.amountPaid > 50000){
      ...
      payment.shipingCharges = 100;
    }

    payment.amountPaid += payment.shipingCharges;
  }
